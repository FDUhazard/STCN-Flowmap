...
class YouTubeVOSTestDataset(Dataset):
    def __init__(self, data_root, split, res=480):
        ...
        self.flow_dir = path.join(data_root, 'all_frames', split+'_all_frames', 'JPEGFlows')
    ...
    def __getitem__(self, idx):
        ...
        vid_flow_path = path.join(self.flow_dir, video)
        ...
        for i, f in enumerate(frames):
            ...
            flow = Image.open(path.join(vid_flow_path, f)).convert('RGB')
            flows.append(self.im_transform(flow))
