...
from model.network import NewDecoder
...
class STCN(nn.Module):
    ...
    def encode_flow(self, frame):
        ...
        s16, s8, s4 = self.flow_encoder(frame)

        return s16, s8, s4

    def segment_with_query(self, mem_bank, qf8, qf4, qk16, qv16, s16, s8, s4): 
        ...
        return torch.sigmoid(self.decoder(qv16, qf8, qf4, s16, s8, s4))
